...
abstract class AbstractPlatformAssetService(
    ...
    protected fun stringToColor(stringColor: String): Color {
        return COLOR_MAP[stringColor.lowercase()] ?: throw AssetServiceReferenceException("unknown color: $stringColor")
    }
}
