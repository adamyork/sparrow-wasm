...
abstract class CommonEngine @AppScope @Inject constructor(
    ...
    protected open var mapItem: Item = CommonItem()
    abstract var mapItemImage: CommonImage
    abstract var playerImage: CommonImage

    protected open val itemImageCache: HashMap<String, CommonImage> = hashMapOf()
    protected open val enemyImageCache: HashMap<String, CommonImage> = hashMapOf()
    protected open val flippedFrameCache: HashMap<String, CommonImage> = hashMapOf()
